...
abbr_map = pd.read_csv("zone_abbreviation_mapping_FINAL_UPDATED.csv", index_col=0)["GeoJSON Zone Name"].to_dict().to_dict()["GeoJSON Zone Name"].to_dict()["GeoJSON Zone Name"]
