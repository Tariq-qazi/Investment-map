...
'''
m.get_root().html.add_child(folium.Element(legend_html))--- Display Map ---

st.title("Serdal SmartZone Map") st.markdown(f"Quarter: {quarter} | Unit: {unit_type} | Rooms: {rooms} | Mode: {insight_mode}") st_folium(m, width=1200, height=700)
